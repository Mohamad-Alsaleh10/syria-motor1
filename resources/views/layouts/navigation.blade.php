<nav x-data="{ open: false }" class="bg-white border-b border-gray-100" >
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        @if(Auth::user()->isAdmin())
                            ...
                            <x-nav-link :href="route('admin.rental-ads.index')" :active="request()->routeIs('admin.rental-ads.index')">
                                {{ __('إدارة إعلانات التأجير') }}
                            </x-nav-link>
                            <x-nav-link :href="route('admin.auctions.index')" :active="request()->routeIs('admin.auctions.index')">
                                {{ __('إدارة المزادات') }}
                            </x-nav-link>
                            <x-nav-link :href="route('admin.workshops.index')" :active="request()->routeIs('admin.workshops.index')">
                                {{ __('إدارة الورش') }}
                            </x-nav-link>
                            <x-nav-link :href="route('admin.service-requests.index')" :active="request()->routeIs('admin.service-requests.index')">
                                {{ __('إدارة طلبات الخدمة') }}
                            </x-nav-link>
                            <x-nav-link :href="route('admin.promotions.index')" :active="request()->routeIs('admin.promotions.index')">
                                {{ __('إدارة العروض الترويجية') }}
                            </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            {{-- روابط لوحة تحكم المدير المستجيبة --}}
            @auth
                @if(Auth::user()->isAdmin())
                    ...
                    <x-responsive-nav-link :href="route('admin.ads.index')" :active="request()->routeIs('admin.ads.index')">
                        {{ __('إدارة إعلانات البيع') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.rental-ads.index')" :active="request()->routeIs('admin.rental-ads.index')">
                        {{ __('إدارة إعلانات التأجير') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.auctions.index')" :active="request()->routeIs('admin.auctions.index')">
                        {{ __('إدارة المزادات') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.workshops.index')" :active="request()->routeIs('admin.workshops.index')">
                        {{ __('إدارة الورش') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('admin.service-requests.index')" :active="request()->routeIs('admin.service-requests.index')">
                        {{ __('إدارة طلبات الخدمة') }}
                    </x-responsive-nav-link>
